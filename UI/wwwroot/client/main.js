...
var StoreService = /** @class */ (function () {
    ...
    StoreService.prototype.GetProducts = function () {
        return this.httpClient.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiAddress + "/store");
    };
    StoreService.prototype.SaveCart = function (cart) {
        return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiAddress + "/store", JSON.stringify(cart), { headers: this.headers });
    };
...
module.exports = __webpack_require__(/*! E:\MP\MPSite\UI\client\src\main.ts */"./src/main.ts");
