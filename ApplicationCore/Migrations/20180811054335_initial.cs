        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress = table.Column<string>(type: "varchar(500)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Tran_Id = table.Column<string>(type: "varchar(20)", nullable: true),
                    Status = table.Column<string>(type: "varchar(10)", nullable: true),
                    PaymentType = table.Column<string>(type: "varchar(10)", nullable: true),
                    UserId = table.Column<int>(nullable: false),
                    CartId = table.Column<int>(nullable: false),
